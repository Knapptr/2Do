...
/*!************************!*\
  !*** ./src/display.js ***!
  \************************/
/*! exports provided: display, assignCardEvents */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "display", function() { return display; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "assignCardEvents", function() { return assignCardEvents; });
...
/* harmony import */ var _popUpBehavior__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./popUpBehavior */ "./src/popUpBehavior.js");
...
let display = {
    renderList(source,dest){
        ...
        source.forEach(el => {
            ...
            let newEl = _taskCard__WEBPACK_IMPORTED_MODULE_1__["taskCard"].cardContent(el)
            dest.appendChild(newEl);
        })
    } else{
        let newEl = _taskCard__WEBPACK_IMPORTED_MODULE_1__["taskCard"].cardContent(source)
...
let assignCardEvents = () =>{


    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.cards = document.querySelectorAll('.taskCard')
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.completeState = document.querySelectorAll('.completeState')
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.completeBtn = document.querySelectorAll('.markComplete')
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.deleteBtn = document.querySelectorAll('.deleteBtn')
    
    
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.cards.forEach(el=>{
        el.addEventListener('dblclick',function(){
            
            _popUpBehavior__WEBPACK_IMPORTED_MODULE_3__["popUp"].toggle();
            
            _popUpBehavior__WEBPACK_IMPORTED_MODULE_3__["popUp"].renderPopUp(_todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].list[this.dataset.index])
            display.clearDisplay(_gui__WEBPACK_IMPORTED_MODULE_0__["gui"].window.list)
        })
    })
    
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.completeBtn.forEach(el=>{                  //Assigns incomplete tasks a complete btn
        el.addEventListener('click',function(){
            
            _todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].markItemComplete(el.dataset.index)
    ...
    _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].card.deleteBtn.forEach(el=>{
        el.addEventListener('click',function(){
            
            _todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].removeItem(el.dataset.index)
        })
    })
}
...
/* harmony import */ var _searchList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./searchList */ "./src/searchList.js");
/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./display */ "./src/display.js");
/* harmony import */ var _localStorageGetSet__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./localStorageGetSet */ "./src/localStorageGetSet.js");
...
let gui = {
       ...
       mainViewToggle(){
        ...
        initialize(){
            _localStorageGetSet__WEBPACK_IMPORTED_MODULE_4__["local"].init();
            _display__WEBPACK_IMPORTED_MODULE_3__["display"].clearDisplay(gui.window.list)
...
let behavior = (function (){
    gui.sub.submitBtn.addEventListener('click', ()=>{//////////Submission click
      let newEvent = Object(_todo__WEBPACK_IMPORTED_MODULE_0__["toDoEvent"])(gui.sub.taskNameIn.value, gui.sub.projectIn.value);
      console.log(gui.sub.dueDateIn.value)
      if(gui.sub.dueDateIn.value){newEvent.setDue(gui.sub.dueDateIn.value)}
     
      
      _todolist__WEBPACK_IMPORTED_MODULE_1__["toDoList"].addProject(gui.sub.projectIn.value)
      newEvent.addToList(_todolist__WEBPACK_IMPORTED_MODULE_1__["toDoList"].list);
    ...
    gui.search.taskSearchBtn.addEventListener('click',()=>{//////////task search
        ...
        let results = Object(_searchList__WEBPACK_IMPORTED_MODULE_2__["search"])(_todolist__WEBPACK_IMPORTED_MODULE_1__["toDoList"].list, 'task',gui.search.taskSearchIn.value)
        _display__WEBPACK_IMPORTED_MODULE_3__["display"].clearDisplay(gui.window.list)
        _display__WEBPACK_IMPORTED_MODULE_3__["display"].renderList(results,gui.window.list);
        clearer(gui.search)
    })
    gui.footControls.clear.addEventListener('click',_todolist__WEBPACK_IMPORTED_MODULE_1__["toDoList"].clearAll);
...
/* harmony import */ var _searchList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./searchList */ "./src/searchList.js");
...
/* harmony import */ var _taskCard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./taskCard */ "./src/taskCard.js");
/* harmony import */ var _popUpBehavior__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./popUpBehavior */ "./src/popUpBehavior.js");
/* harmony import */ var _popUpContent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./popUpContent */ "./src/popUpContent.js");
/* harmony import */ var _localStorageGetSet__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./localStorageGetSet */ "./src/localStorageGetSet.js");
...
/////////////////////////////////////////
_gui__WEBPACK_IMPORTED_MODULE_4__["gui"].sub.populatePjList(_todolist__WEBPACK_IMPORTED_MODULE_5__["toDoList"].projects)
...
_gui__WEBPACK_IMPORTED_MODULE_4__["gui"].initialize();



/***/ }),

/***/ "./src/localStorageGetSet.js":
/*!***********************************!*\
  !*** ./src/localStorageGetSet.js ***!
  \***********************************/
...
let local = {
    localParser(arrayOfTasks){
        arrayOfTasks.forEach(el=>{
           if(el.dateDue){
               el.dateDue = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["parseISO"])(el.dateDue)
           }
    ...
    init(){
        ...
        _todolist__WEBPACK_IMPORTED_MODULE_0__["toDoList"].list = parsedList;
        /////////////project list
        _todolist__WEBPACK_IMPORTED_MODULE_0__["toDoList"].initProjects();
        localStorage.setItem('projects',JSON.stringify(_todolist__WEBPACK_IMPORTED_MODULE_0__["toDoList"].projects))
...
/* harmony import */ var _todolist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todolist */ "./src/todolist.js");
/* harmony import */ var _popUpContent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./popUpContent */ "./src/popUpContent.js");
...
let popUp ={
    ...
    renderPopUp(source){
        ...
        _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].options.innerHTML=""
        _todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].projects.forEach(el=>{
            if(el!=="" && el!==" "){
            let newOption = document.createElement('option');
            newOption.textContent=el
            _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].options.appendChild(newOption);
            
            }
        })
        let saver = function(){
            popUp.submitData(source,_todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].list)
            reset();
            popUp.toggle();
        }
        let close = function(){
        ...
        let reset= function(){
            _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].clearer(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"]);
            _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].closeBtn.removeEventListener('click',close)
            _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].saveBtn.removeEventListener('click',saver)
        }
        reset();
        ...
        _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].closeBtn.addEventListener('click',close)
       
        
        _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].saveBtn.addEventListener('click',saver)
        
        _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].taskName.value = source.task;
        
        if(source.dateDue){_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].dueDate.value = (Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(source.dateDue,'yyyy-MM-dd'))}
        _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].projectSelector.value = source.project;
        
        if(source.notes){_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].notesField.value = source.notes};
        
        if(source.complete){_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].completeBox.checked = true}else{_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].completeBox.checked = false}
        
        
    },
    submitData(source,dest){
        
        let replacementEvent = Object(_todo__WEBPACK_IMPORTED_MODULE_5__["toDoEvent"])(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].taskName.value,_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].projectSelector.value)
        if(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].dueDate.value){replacementEvent.setDue(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].dueDate.value)}
        replacementEvent.dataID = source.dataID
        if(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].notesField.value){replacementEvent.notes = _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].notesField.value}
        replacementEvent.complete = _popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].completeBox.checked
        if(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].projectSelector.value){
            _todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].addProject(_popUpContent__WEBPACK_IMPORTED_MODULE_3__["popUpBox"].projectSelector.value)
            _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].sub.populatePjList(_todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].projects);
            _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].search.refreshPjList();
        }
...
/*!*****************************!*\
  !*** ./src/popUpContent.js ***!
  \*****************************/
/*! exports provided: popUpBox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popUpBox", function() { return popUpBox; });
/* harmony import */ var _gui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gui */ "./src/gui.js");



let popUpBox = {
    taskName: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#taskName'),
    dueDate: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#dueDate'),
    completeBox: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#completeCheckBox'),
    projectSelector: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#pjSelection'),
    notesField: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#notesField'),
    saveBtn: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#saveBtn'),
    closeBtn: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector('#closePopup'),
    options: _gui__WEBPACK_IMPORTED_MODULE_0__["gui"].popup.popup.querySelector("#editorPjs")
...
let taskCard ={
    ...
    <div class="remainingTimeCard">
        ${el.dateDue?Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["formatDistanceToNow"])(el.dateDue):""}
    </div>
    ...
    <div class="dueDate cardText">
        ${el.dateDue?" Due Date: " + Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(el.dateDue,'EEEE, d MMM yyyy'): ""}
    </div>
...
/*!*********************!*\
  !*** ./src/todo.js ***!
  \*********************/
/*! exports provided: toDoEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toDoEvent", function() { return toDoEvent; });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/index.js");
/* harmony import */ var _localStorageGetSet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./localStorageGetSet */ "./src/localStorageGetSet.js");
/* harmony import */ var _todolist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todolist */ "./src/todolist.js");



//todoDefinition
let toDoEvent = function(task,project){
    let dataID;
    let complete = false;
    let dateAssigned = Date();
    let dateDue;
    let setDue = function(date){
        this.dateDue = Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["parse"])(date,'yyyy-MM-dd',new Date())
    ...
    let addToList = function(destination){
        ...
        _localStorageGetSet__WEBPACK_IMPORTED_MODULE_1__["local"].save(_todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].list,_todolist__WEBPACK_IMPORTED_MODULE_2__["toDoList"].projects)
...
/* harmony import */ var _localStorageGetSet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorageGetSet */ "./src/localStorageGetSet.js");
/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./display */ "./src/display.js");
...
let toDoList = {
    ...
    _localStorageGetSet__WEBPACK_IMPORTED_MODULE_0__["local"].save(toDoList.list,toDoList.projects)
    _display__WEBPACK_IMPORTED_MODULE_1__["display"].clearDisplay(_gui__WEBPACK_IMPORTED_MODULE_2__["gui"].window.list)
    _display__WEBPACK_IMPORTED_MODULE_1__["display"].renderList(toDoList.list,_gui__WEBPACK_IMPORTED_MODULE_2__["gui"].window.list)
    _gui__WEBPACK_IMPORTED_MODULE_2__["gui"].initialize();
